...
for epoch in range(1, PretrainConfig.num_epochs + 1):
    ...
    print(f"Epoch [{epoch}/{PretrainConfig.num_epochs}] - Circulatory Failure Loss: {avg_loss:.6f}")
...
}, "ckpt/trace_finetune_circulatory_failure.pt")
print("✅ Circulatory failure fine-tuning complete.")
